...
class UserPrincipalPreferences {
  /// Returns a new [UserPrincipalPreferences] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserPrincipalPreferences &&
  ...
  /// Returns a new [UserPrincipalPreferences] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static UserPrincipalPreferences fromJson(Map<String, dynamic> json) => json == null
    ? null
    : UserPrincipalPreferences(
  ...
  static List<UserPrincipalPreferences> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <UserPrincipalPreferences>[]
      : json.map((v) => UserPrincipalPreferences.fromJson(v)).toList(growable: true == growable);

  static Map<String, UserPrincipalPreferences> mapFromJson(Map<String, dynamic> json) {
    final map = <String, UserPrincipalPreferences>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = UserPrincipalPreferences.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of UserPrincipalPreferences-objects as value to a dart map
  static Map<String, List<UserPrincipalPreferences>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UserPrincipalPreferences>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UserPrincipalPreferences.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
