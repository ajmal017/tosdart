...
class MarginAccountOrderStrategies {
  /// Returns a new [MarginAccountOrderStrategies] instance.
  ...
  Execution orderActivityCollection;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MarginAccountOrderStrategies &&
  ...
  /// Returns a new [MarginAccountOrderStrategies] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static MarginAccountOrderStrategies fromJson(Map<String, dynamic> json) => json == null
    ? null
    : MarginAccountOrderStrategies(
        ...
        orderActivityCollection: Execution.fromJson(json[r'orderActivityCollection']),
  ...
  static List<MarginAccountOrderStrategies> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <MarginAccountOrderStrategies>[]
      : json.map((v) => MarginAccountOrderStrategies.fromJson(v)).toList(growable: true == growable);

  static Map<String, MarginAccountOrderStrategies> mapFromJson(Map<String, dynamic> json) {
    final map = <String, MarginAccountOrderStrategies>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = MarginAccountOrderStrategies.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of MarginAccountOrderStrategies-objects as value to a dart map
  static Map<String, List<MarginAccountOrderStrategies>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<MarginAccountOrderStrategies>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = MarginAccountOrderStrategies.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
