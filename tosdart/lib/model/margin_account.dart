...
class MarginAccount {
  /// Returns a new [MarginAccount] instance.
  MarginAccount({
    this.accountId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MarginAccount &&
  ...
  /// Returns a new [MarginAccount] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static MarginAccount fromJson(Map<String, dynamic> json) => json == null
    ? null
    : MarginAccount(
  ...
  static List<MarginAccount> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <MarginAccount>[]
      : json.map((v) => MarginAccount.fromJson(v)).toList(growable: true == growable);

  static Map<String, MarginAccount> mapFromJson(Map<String, dynamic> json) {
    final map = <String, MarginAccount>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = MarginAccount.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of MarginAccount-objects as value to a dart map
  static Map<String, List<MarginAccount>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<MarginAccount>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = MarginAccount.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
