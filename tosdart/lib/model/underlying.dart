...
class Underlying {
  /// Returns a new [Underlying] instance.
  Underlying({
    this.ask,
    this.askSize,
    this.bid,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Underlying &&
     other.ask == ask &&
  ...
  /// Returns a new [Underlying] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static Underlying fromJson(Map<String, dynamic> json) => json == null
    ? null
    : Underlying(
        ask: json[r'ask'] == null ?
          null :
  ...
  static List<Underlying> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Underlying>[]
      : json.map((v) => Underlying.fromJson(v)).toList(growable: true == growable);

  static Map<String, Underlying> mapFromJson(Map<String, dynamic> json) {
    final map = <String, Underlying>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = Underlying.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of Underlying-objects as value to a dart map
  static Map<String, List<Underlying>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<Underlying>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = Underlying.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
