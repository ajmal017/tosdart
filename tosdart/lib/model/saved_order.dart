...
class SavedOrder {
  /// Returns a new [SavedOrder] instance.
  SavedOrder({
    this.accountId,
  ...
  List<SavedOrderChildOrderStrategies> childOrderStrategies;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SavedOrder &&
     ...
     other.savedOrderId == savedOrderId &&
  ...
  int get hashCode =>
    ...
    (savedOrderId == null ? 0 : savedOrderId.hashCode) +
    (savedTime == null ? 0 : savedTime.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (savedOrderId != null) {
      json[r'savedOrderId'] = savedOrderId;
    }
    if (savedTime != null) {
      json[r'savedTime'] = savedTime;
    }
    if (session != null) {
  ...
  /// Returns a new [SavedOrder] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static SavedOrder fromJson(Map<String, dynamic> json) => json == null
    ? null
    : SavedOrder(
        ...
        childOrderStrategies: SavedOrderChildOrderStrategies.listFromJson(json[r'childOrderStrategies']),
        ...
        savedOrderId: json[r'savedOrderId'] == null ?
          null :
          json[r'savedOrderId'].toDouble(),
        savedTime: json[r'savedTime'],
  ...
  static List<SavedOrder> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <SavedOrder>[]
      : json.map((v) => SavedOrder.fromJson(v)).toList(growable: true == growable);

  static Map<String, SavedOrder> mapFromJson(Map<String, dynamic> json) {
    final map = <String, SavedOrder>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = SavedOrder.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of SavedOrder-objects as value to a dart map
  static Map<String, List<SavedOrder>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<SavedOrder>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = SavedOrder.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
