...
class Order {
  ...
  List<OrderChildOrderStrategies> childOrderStrategies;
  ...
  List<OrderOrderLegCollection> orderLegCollection;
  ...
  static Order fromJson(Map<String, dynamic> json) => json == null
    ...
    : Order(
        ...
        childOrderStrategies: OrderChildOrderStrategies.listFromJson(json[r'childOrderStrategies']),
        ...
        orderLegCollection: OrderOrderLegCollection.listFromJson(json[r'orderLegCollection']),
