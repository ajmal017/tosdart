...
class UpdatePreferences {
  /// Returns a new [UpdatePreferences] instance.
  UpdatePreferences({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdatePreferences &&
  ...
  /// Returns a new [UpdatePreferences] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static UpdatePreferences fromJson(Map<String, dynamic> json) => json == null
    ? null
    : UpdatePreferences(
        ...
        defaultEquityQuantity: json[r'defaultEquityQuantity'],
  ...
  static List<UpdatePreferences> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <UpdatePreferences>[]
      : json.map((v) => UpdatePreferences.fromJson(v)).toList(growable: true == growable);

  static Map<String, UpdatePreferences> mapFromJson(Map<String, dynamic> json) {
    final map = <String, UpdatePreferences>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = UpdatePreferences.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of UpdatePreferences-objects as value to a dart map
  static Map<String, List<UpdatePreferences>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UpdatePreferences>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UpdatePreferences.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
